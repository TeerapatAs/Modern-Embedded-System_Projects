...
3. Check if the data transmission in 2. is working by connecting the pin A9 to Arduino UNO's pin A0 for the Arduino serial plotter.
   ![graph](https://github.com/user-attachments/assets/9231ae03-51b8-4b2e-89fd-d09f05eb2eb4)
   <img width="500" height="478" alt="image" src="(https://github.com/user-attachments/assets/9231ae03-51b8-4b2e-89fd-d09f05eb2eb4)" />
